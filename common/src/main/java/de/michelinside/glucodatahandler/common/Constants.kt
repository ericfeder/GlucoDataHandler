...
object Constants {
    ...
    const val SHARED_PREF_PREDICTIONS_ENABLED = "predictions_enabled"
    const val SHARED_PREF_SHOW_MODEL_ARROW = "show_model_arrow"
    const val SHARED_PREF_PREDICTION_MODEL = "prediction_model"
    const val PREDICTION_MODEL_BASELINE = "baseline"
    const val PREDICTION_MODEL_E2 = "e2"
